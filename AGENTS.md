...
- **Define acceptance evidence:** After design approval, update the issue from the approved research before coding, including production-path tests, evaluations, performance checks, and human verification where applicable.
